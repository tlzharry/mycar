...
def stop_obstacle(image):
    ...
    if lines is not None:
        ...
        # 定義車道範圍多邊形
        lane_polygon = [(min_x+10, min_y-10), (max_x, min_y-10), (max_x, max_y), (min_x+10, max_y)]

        # 裁切影像
        new_cropped_image = original_cropped_image[min_y:max_y, min_x:max_x]
    else:
        new_cropped_image = original_cropped_image
    ...
    return edges, new_cropped_image, binary_inv
